...
For instructions to setup Caddy, see instructions [here](https://caddyserver.com/docs/install#docker).  Please remember that after making changes to your Caddyfile, the Caddy service must be restarted to take effect.
